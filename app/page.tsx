...
<section className="launch-hero" aria-labelledby="launch-title"><img className="launch-landscape" src="/assets/hero/webstell-landscape.avif" alt="A retro computer in a sunlit green landscape"/><div className="launch-wash" aria-hidden="true"></div><div className="launch-copy"><span className="launch-kicker">INDEPENDENT MINDS. ONE CREATIVE STUDIO.</span><h1 id="launch-title"><span>Websites people</span><strong>remember<span className="hero-period">.</span></strong></h1><p>Websites, custom software, portfolios and mobile apps. We design and build the things your business needs—with a team you can actually talk to.</p><button ref={heroCta} onClick={()=>setContact(true)}><span className="cta-eyes" aria-hidden="true"><i><b></b></i><i><b></b></i></span> Let’s build your idea <span className="hero-cta-arrow" aria-hidden="true">↗</span></button><a className="hero-secondary" href="/pricing">Find your starting price <span aria-hidden="true">↗</span></a></div><HeroProjects/><div className="launch-capabilities"><p>We build what’s next.<br/><span>You take it further.</span></p><div>{['Websites','Software','Mobile Apps','Portfolios','Chatbots','AI Automations'].map(item=><a key={item} href="/#services">{item}<span aria-hidden="true">↗</span></a>)}</div></div></section>
 ...
 <section className="service-spectrum wrap" aria-labelledby="service-spectrum-title">
   ...
   <div className="service-spectrum-grid">
     <article className="service-spectrum-card service-spectrum-web"><div className="service-card-top"><span>01 / Websites</span><i aria-hidden="true">↗</i></div><div className="web-window" aria-hidden="true"><b></b><b></b><b></b><div><span>YOUR NEXT<br/>BIG IDEA.</span><i></i></div></div><h3>Website design &amp; development</h3><p>Clear, fast websites that make your business memorable and easy to choose.</p><ul><li>Strategy &amp; content</li><li>Design &amp; build</li><li>Search-ready launch</li></ul></article>
     <article className="service-spectrum-card service-spectrum-commerce"><div className="service-card-top"><span>02 / Commerce</span><i aria-hidden="true">↗</i></div><div className="commerce-orbit" aria-hidden="true"><span>₹</span><i></i><b>+</b><em>SHOP<br/>NOW</em></div><h3>Ecommerce &amp; online stores</h3><p>Shopping experiences designed to turn discovery into confident orders.</p><ul><li>Shopify &amp; custom stores</li><li>Payments &amp; shipping</li></ul></article>
     <article className="service-spectrum-card service-spectrum-brand"><div className="service-card-top"><span>03 / Identity</span><i aria-hidden="true">↗</i></div><div className="brand-shapes" aria-hidden="true"><i></i><i></i><i></i><b>UX</b></div><h3>Brand identity &amp; UI/UX</h3><p>A visual voice and interface system people understand at a glance.</p><ul><li>Brand systems</li><li>Product &amp; web UI</li></ul></article>
     <article className="service-spectrum-card service-spectrum-automation"><div className="service-card-top"><span>04 / Automation</span><i aria-hidden="true">↗</i></div><div className="automation-map" aria-hidden="true"><i></i><i></i><i></i><i></i><b></b><b></b><b></b></div><h3>Software &amp; automation</h3><p>Useful tools and connected workflows that give your team more time.</p><ul><li>Portals &amp; dashboards</li><li>AI workflows &amp; APIs</li></ul></article>
     <article className="service-spectrum-card service-spectrum-mobile"><div className="service-card-top"><span>05 / Mobile</span><i aria-hidden="true">↗</i></div><div className="mobile-device" aria-hidden="true"><b></b><div><span>12:45</span><i></i><i></i><i></i><em>Made for the<br/>moment.</em></div></div><h3>Mobile apps</h3><p>Reliable Android and iOS experiences built around real daily use.</p><ul><li>iOS &amp; Android</li><li>Product design to launch</li></ul></article>
     <article className="service-spectrum-card service-spectrum-ai"><div className="service-card-top"><span>06 / Intelligence</span><i aria-hidden="true">↗</i></div><div className="ai-conversation" aria-hidden="true"><span>Hello! How can we help?</span><i>Tell me about your project.</i><b><em></em><em></em><em></em></b></div><h3>AI chatbots &amp; assistants</h3><p>Helpful conversations that qualify leads and keep customers supported.</p><ul><li>Website &amp; WhatsApp bots</li><li>Knowledge assistants</li></ul></article>
   </div>
 </section>
 <CurvedTicker/>
