...
const offerServices: OfferService[] = [
  {
    ...
    image: '/assets/service-webstell.png',
    imageAlt: 'Webstell websites, software and creative services artwork',
    fit: 'contain',
  },
  {
    ...
    image: '/assets/service-elevare.png',
    imageAlt: 'Sports ecommerce experience displayed on a laptop',
  },
  {
